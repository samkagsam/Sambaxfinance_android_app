...
class EmailSignupOtpActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_email_signup_otp)


        val signtoken = intent.getStringExtra(EXTRA_MESSAGE_EMAIL_SIGN_OTP_TOKEN)
        ...
        val buttonSendOtp = findViewById<Button>(R.id.buttonSendOtpEmail)
        val otp_given = findViewById<EditText>(R.id.etOtpNumberEmail)
            ...
            response.sendReq(userCreateRequestModel,"Bearer " + signtoken).enqueue(
                object : Callback<LoginResponseModel> {
                    override fun onResponse(
                        ...
                        Toast.makeText(this@EmailSignupOtpActivity,response.message().toString(), Toast.LENGTH_LONG).show()
                        ...
                        if (okResponse == "Created"){
                            ...
                            val intent = Intent(this@EmailSignupOtpActivity, LandingActivity::class.java).apply {
                    ...
                    override fun onFailure(call: Call<LoginResponseModel>, t: Throwable) {
                        Toast.makeText(this@EmailSignupOtpActivity,t.toString(), Toast.LENGTH_LONG).show()
                        println("we failed")
                        //println(t.toString())
                        // Capture the layout's TextView and set the string as its text
                        val tvResponseOtp = findViewById<TextView>(R.id.tvResponseOtp).apply {
