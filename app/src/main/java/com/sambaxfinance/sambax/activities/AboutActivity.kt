...
class AboutActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val bottomNavigationView = findViewById<BottomNavigationView>(R.id.bottomNavigationViewAboutActivity)
        ...
        val webViewAbout = findViewById<WebView>(R.id.webViewAbout)
        ...
        webViewAbout.loadUrl("https://www.sambaxfinance.com/about_us")
