...
import com.sambaxfinance.sambax.api.ApiInterfaceSarAddMoneyByCard
...
class SarAddMoneyByCardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sar_add_money_by_card)
        ...
        val bottomNavigationView = findViewById<BottomNavigationView>(R.id.bottomNavigationViewSarAddMoneyByCardActivity)
        ...
        buttonAddMoney.setOnClickListener {
            ...
            val response = ServiceBuilder.buildService(ApiInterfaceSarAddMoneyByCard::class.java)
            response.sendReq(addMoneyByCardRequestModel,"Bearer " + token).enqueue(
                object : Callback<AddMoneyByCardResponseModel> {
                    override fun onResponse(
                        ...
                        Toast.makeText(this@SarAddMoneyByCardActivity,response.message().toString(), Toast.LENGTH_LONG).show()
                        ...
                        if (okResponse == "Created"){
                            ...
                            val intent = Intent(this@SarAddMoneyByCardActivity, WalletActivity::class.java).apply {
                            ...
                            Toast.makeText(this@SarAddMoneyByCardActivity,"Error in processing deposit", Toast.LENGTH_LONG).show()
                            // Capture the layout's TextView and set the string as its text
                    ...
                    override fun onFailure(call: Call<AddMoneyByCardResponseModel>, t: Throwable) {
                        Toast.makeText(this@SarAddMoneyByCardActivity,t.toString(), Toast.LENGTH_LONG).show()
                        println("we failed")
                        println(t.toString())
