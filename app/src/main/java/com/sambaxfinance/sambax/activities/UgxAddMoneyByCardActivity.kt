...
class UgxAddMoneyByCardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonAddMoney.setOnClickListener {
            ...
            val response = ServiceBuilder.buildService(ApiInterfaceUgXAddMoneyByCard::class.java)
            response.sendReq(addMoneyByCardRequestModel,"Bearer " + token).enqueue(
                object : Callback<AddMoneyByCardResponseModel> {
                    override fun onResponse(
                        ...
                        Toast.makeText(this@UgxAddMoneyByCardActivity,response.message().toString(), Toast.LENGTH_LONG).show()
                        ...
                        if (okResponse == "Created"){
                            ...
                            val intent = Intent(this@UgxAddMoneyByCardActivity, WalletActivity::class.java).apply {
                            ...
                            Toast.makeText(this@UgxAddMoneyByCardActivity,"Error in processing deposit", Toast.LENGTH_LONG).show()
                            // Capture the layout's TextView and set the string as its text
                    ...
                    override fun onFailure(call: Call<AddMoneyByCardResponseModel>, t: Throwable) {
                        Toast.makeText(this@UgxAddMoneyByCardActivity,t.toString(), Toast.LENGTH_LONG).show()
                        println("we failed")
                        println(t.toString())
