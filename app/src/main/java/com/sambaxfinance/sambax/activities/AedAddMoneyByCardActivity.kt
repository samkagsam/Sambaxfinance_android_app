...
import com.sambaxfinance.sambax.api.ApiInterfaceAedAddMoneyByCard
...
class AedAddMoneyByCardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_aed_add_money_by_card)
        ...
        val bottomNavigationView = findViewById<BottomNavigationView>(R.id.bottomNavigationViewAedAddMoneyByCardActivity)
        ...
        buttonAddMoney.setOnClickListener {
            ...
            val response = ServiceBuilder.buildService(ApiInterfaceAedAddMoneyByCard::class.java)
            response.sendReq(addMoneyByCardRequestModel,"Bearer " + token).enqueue(
                object : Callback<AddMoneyByCardResponseModel> {
                    override fun onResponse(
                        ...
                        Toast.makeText(this@AedAddMoneyByCardActivity,response.message().toString(), Toast.LENGTH_LONG).show()
                        ...
                        if (okResponse == "Created"){
                            ...
                            val intent = Intent(this@AedAddMoneyByCardActivity, WalletActivity::class.java).apply {
                            ...
                            Toast.makeText(this@AedAddMoneyByCardActivity,"Error in processing deposit", Toast.LENGTH_LONG).show()
                            // Capture the layout's TextView and set the string as its text
                    ...
                    override fun onFailure(call: Call<AddMoneyByCardResponseModel>, t: Throwable) {
                        Toast.makeText(this@AedAddMoneyByCardActivity,t.toString(), Toast.LENGTH_LONG).show()
                        println("we failed")
                        println(t.toString())
